...
<div class="card col span_1_of_4">
  <div class="shop-item">
    ...
    <div class="metacat"><a class="metacat" href="<?php  echo $article->Category->Url;  ?>"><?php  echo $article->Category->Name;  ?></a></div>
		<a href="<?php  echo $article->Url;  ?>" title="<?php  echo $article->Title;  ?>"><img class="thumb" style="width:253px;height:169px" src="<?php  echo $temp;  ?>" alt="<?php  echo $article->Title;  ?>"></a>
	</div>
	<h3><a href="<?php  echo $article->Url;  ?>" alt="<?php  echo $article->Title;  ?>" title="<?php  echo $article->Title;  ?>" target="_blank">【置顶】<?php  echo $article->Title;  ?></a></h3>

...
<?php if ($article->Category->ID==$zbp->Config('Lucky')->twitter) { ?>
	<?php  include $this->GetTemplate('twitter');  ?>
<?php }else{  ?>
	<div class="post-box tra">
		<div class="post-thumb">
			<div class="post-cate tra">
				<ul class="post-categories"><li><a href="<?php  echo $article->Category->Url;  ?>" rel="category tag"><?php  echo $article->Category->Name;  ?></a></li></ul>
			</div>
		...
		<div class="post-main">
			<div class="post-header">
				<h2 class="post-title tra">
					<a href="<?php  echo $article->Url;  ?>" class="inlo-a tra" title="<?php  echo $article->Title;  ?>"><?php  echo $article->Title;  ?>

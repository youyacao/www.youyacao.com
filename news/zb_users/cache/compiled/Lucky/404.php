...
body{background: #dfdfdf url(<?php  echo Lucky_Host();  ?>zb_users/theme/Lucky/style/image/404_bg.jpg) repeat; font-family: Helvetica, Arial, sans-serif; -webkit-font-smoothing: antialiased; overflow: hidden;}
...
<body>
	<div id="Lucky">
		...
		<div id="content">
			<h2>您打开的这个的页面不存在！</h2>
			<p>当您看到这个页面，表示您的访问出错，这个错误是您打开的页面不存在，请确认您输入的地址是正确的，如果是在本站点击后出现这个页面，请联系站长进行处理，或者请通过下边的搜索重新查找资源，<?php  echo $name;  ?>感谢您的支持!</p>
			<div class="utilities">
				<form name="search" method="post" class="s-form" id="formkeyword" action="<?php  echo $host;  ?>zb_system/cmd.php?act=search">
			...
			<div class="buttons">
				...
				<span><a class="button" href="<?php  echo $host;  ?>">返回首页</a></span>
			</div>
			<div class="clear"></div>
		</div>
		<div id="footer">
			<ul>
				Powered By <li><a href="http://www.zblogcn.com/" rel="nofollow" target="_blank"> ZblogPhp</a></li>,Template By <li><a href="https://Www.SongHaiFeng.Com" target="_blank"> 小锋博客</a></li>
			</ul>
		</div>
	</div>
</body>

...
<header class="article-header"><h1 class="article-title"><a href="{$article.Url}">{$article.Title}</a></h1>
	<div class="meta">
		<span class="muted"><i class="fa fa-user"></i> <a href="{$article.Author.Url}">{$article.Author.Name}</a></span>
		<time class="muted"><i class="fa fa-clock-o"></i>{$article.Time('Y-m-d')}</time>

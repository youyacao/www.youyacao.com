...
<div class="card col span_1_of_4">
  <div class="shop-item">
    ...
    <div class="metacat"><a class="metacat" href="{$article.Category.Url}">{$article.Category.Name}</a></div>
		<a href="{$article.Url}" title="{$article.Title}"><img class="thumb" style="width:253px;height:169px" src="{$temp}" alt="{$article.Title}"></a>
	</div>
	<h3><a href="{$article.Url}" alt="{$article.Title}" title="{$article.Title}" target="_blank">【置顶】{$article.Title}</a></h3>

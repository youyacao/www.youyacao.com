...
function Lucky_page_readers_cache() {        		 	
	...
	foreach ($array as $key => $comment) {     	 	 			
		$i = $key+1;    		 				 
		$avatarload = '<img src="'.Lucky_Host().'zb_users/theme/Lucky/style/image/grey.gif" data-original="https://cn.gravatar.com/avatar/' .md5(strtolower($comment['comm_Email'])).'" class="avatar avatar-50" height="50" width="50" />';    	 	   		

...
{    	 					 
   ...
   * @return int     	 			 	
   */    	  				 
  public function pre_process($param = array(), $new_captcha = 1)    		 		 		
  {     		 		 	
    $data      = array(    	 		   	
      'gt' => $this->captcha_id,    			   		
   ...
   * @return int    	    	  
   */    		  	  	
  public function success_validate($challenge, $validate, $seccode, $param = array(), $json_format = 1)         	  
  {    	 			 	 

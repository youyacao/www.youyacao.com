		...
		<div class="a-box wechat">
			<div class="wechat-wrap" style="display: none;">
				{if $zbp->Config('Lucky')->qrcode}
					<img src="{Lucky_Host($zbp->Config('Lucky')->qrcode)}" alt="qr_code"/>
				{else}
					<img src="{Lucky_Host()}zb_users/theme/{$theme}/style/image/qr_code.png" alt="qr_code"/>
				{/if}
			</div>
		</div>
		{/if}
...
<div id="footer">
	<div class="container">
		{if $type == 'index' && $page == '1' && Lucky_Links()}
...
<script src="{Lucky_Host()}zb_users/theme/{$theme}/script/typical.js" type="text/javascript"></script>
{if $zbp->Config('Lucky')->sliders=='a'}
	<script src="{Lucky_Host()}zb_users/theme/{$theme}/script/swiper.min.js" type="text/javascript"></script>
{/if}
<script>
...
<script type="text/javascript" src="{Lucky_Host()}zb_users/theme/Lucky/script/pjax.js"></script><div class="pjax_loading"></div>
{/if}
{$footer}
{if !($zbp.user.ID > 0 && $zbp.user.ID < 5) && $zbp->Config('Lucky')->geetest=='a'}
	<script type="text/javascript" src="{Lucky_Host()}zb_users/theme/Lucky/script/gt.js"></script>
	<script type="text/javascript" src="{Lucky_Host()}zb_users/theme/Lucky/script/plugin.js"></script>
{/if}
</body>
</html>
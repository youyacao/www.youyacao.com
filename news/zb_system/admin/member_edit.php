    ...
    ?>
        &nbsp;(
            ...
            <p>
                ...
                <br />
                <input id="edtName" class="edit" size="40" name="Name" pattern=".{<?php echo $zbp->option['ZC_USERNAME_MIN']; ?>,<?php echo $zbp->option['ZC_USERNAME_MAX']; ?>}" maxlength="<?php echo $zbp->option['ZC_USERNAME_MAX']; ?>" type="text" value="<?php echo $member->Name; ?>" <?php if (!$zbp->CheckRights('MemberAll')) {

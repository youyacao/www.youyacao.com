<?php include('post-safe.php');?><div class="commentform">
	...
	<div id="comment">
		<form id="frmSumbit" target="_self" method="post" action="{$article.CommentPostUrl}">
			...
			<p>登录用户：{$user.StaticName}</p>
			{else}
			<div class="item">
				<label>昵称：<i>*</i></label>
				<div class="input">
					<input type="text" name="inpName" id="inpName" class="text" value="{$user.Name}" tabindex="1" placeholder="输入您的称呼"/> 
				</div>
			</div>
			<div class="item">
				<label>邮箱：<i>*</i></label>
				<div class="input">
					<input type="text" name="inpEmail" id="inpEmail" class="text" value="{$user.Email}" tabindex="2" placeholder="输入您的邮箱，我们会为您保密"/>
				</div>
			</div>
			<div class="item">
				<label>网址：</label>
				<div class="input">
					<input type="text" name="inpHomePage" id="inpHomePage" class="text" value="{$user.HomePage}" tabindex="3" placeholder="输入您的个人网站地址，可不填"/>
				</div>
			</div>

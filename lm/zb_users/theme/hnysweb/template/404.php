...
<link rel="stylesheet" href="{$host}zb_users/theme/{$theme}/style/css/404.css">
...
<div class="auto">
  <div class="container">
    <div class="settings"> <i class="icon"></i>
      ...
      <div> <a href="{$host}" title="返回首页">返回首页</a> <a href="javascript:;" title="上一步" id="reload-btn">上一步</a> </div>
    </div>
  </div>
</div>
<script>

	...
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<ul class="nav navbar-nav">
				...
				<li><a href="slides.php">幻灯设置</a></li>
				<li><a href="seo.php">SEO设置</a></li>
				<li><a href="modules.php">模块设置</a></li>
				<li><a href="upload.php">上传设置</a></li>
				<li><a href="color.php">颜色设置</a></li>
				<li><a href="repair.php">修复主题</a></li>
				<li><a href="main.php">主题说明</a></li>
			</ul>

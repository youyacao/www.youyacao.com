...
if ($zbp->Config('Lucky')->twitter != 'off') {      	  	  
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="nopadding col-sm-12">
                            <select class="form-control" name="twitter">
                                <option value="<?php echo $zbp->Config('Lucky')->twitter;?>">
                                    <?php
                                        if ($zbp->Config('Lucky')->twitter == 'off') {     	 			 	
                                            echo '关闭微语';       				 
                                        } else {      	  			
                                            echo $zbp->categorys[$zbp->Config('Lucky')->twitter]->Name;    	  	  		
                                        }       			 	
                                    ?>
                                        
                                </option>
                                <option value="off">关闭微语</option>
                                <?php echo Lucky_Category_twitter();?>
                            </select>
                        </div>
                    </div>
                    <div class="col-sm-6">

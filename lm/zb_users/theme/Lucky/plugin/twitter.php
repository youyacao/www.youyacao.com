...
.lucky-box.Lucky_twitter ul.main input{
	outline:none;
	width:90%;
	line-height: 30px;
    height: 30px;
...
.lucky-box.Lucky_twitter ul.main .includeli input {
	width: 76%;
	border: 1px solid #ccc;
}
.lucky-box.Lucky_twitter ul.main .includeli .button {
	color: #ffffff;
	font-size: 1.1em;
...
.lucky-box.Lucky_twitter ul.main .includeli strong.upload-button {
	background: #3a6ea5;
}
.lucky-box.Lucky_twitter ul.main .includeli span.del-button {
	background: red;
}
.lucky-box.Lucky_twitter ul.main .includeli span.add-button {
	background: green;
}
</style>
<script>
...
<div class="Lucky">
	...
	<?php } ?>
	<?php if ($UEditor && GetVars('act', 'GET') == 'ArticleEdt'){ ?>
	<div class="lucky-box Lucky_twitter">
		<h4>++++++ 微语图片 ++++++</h4>
		<ul class="main" id="photos">
			<?php

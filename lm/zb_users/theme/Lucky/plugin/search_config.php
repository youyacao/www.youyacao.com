...
if ($articles){    		 		 	 
	foreach($articles as $article){            
		$intro = preg_replace('/[\r\n\s]+/', '', trim(Lucky_SubStrStartUTF8(TransferHTML($article->Content,'[nohtml]'),$q,150)) . '...');       			 	
	...
	$zbp->template->SetTags('LuckySearchSubtitle','<p class="Search_no_post_one">请更改关键词后再次搜索；如有问题，请在留言本里反馈，谢谢！</p>');      		 	  
    $pagebar='';     	 	    
    foreach($articles as $article){    			 	  	
